...
*— Ох да, самое время, спасибо. На чем мы остановились?* — ответил ты, отпивая горячий кофе.

*— Удалось закончить с базовой логикой для калькулятора?* 

*— А, это пока еще в процессе. Летучка со Стивом завтра?*

*— Да. Если сможем показать ему хоть какие-нибудь банальные арифметические операции с переработанной структурой программы, то думаю, ему понравится.*
...
*— Что ж, тогда ускоримся.*

*— Кстати, я на днях пересекся с одним разработчиком из Норвегии: то ли Торкве, то ли Трюкве, не помню.* \
...
*— Звучит как именно то, что нам нужно! Я весь внимание.*
...
- Вычисление произвольных скобочных арифметических выражений должно производиться в инфиксной нотации.
- Вычисление произвольных скобочных арифметических выражений должно производиться в инфиксной нотации с подстановкой значения переменной _x_ в виде числа.
